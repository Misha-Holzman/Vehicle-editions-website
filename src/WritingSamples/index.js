      ...
      <div className='writing-samples-main-container'>
        ...
        <div className='writing-samples-main-div'>
          <div className='donna-dennis-passage-div'>
            <h3 className='dennis-passage-title dennis-text'><a href='#' className='link-to-dennis-passage' target='_blank'>Passage: Donna Dennis at Lesley Heller</a></h3>
            ...
            <p className='dennis-text dennis-article-writing'>
              ...
              carrying coal, is so small, so far in the distance. And what looks like a heap of rubble under the dock suggests piled up coal
            </p>
            <p className='dennis-text dennis-article-writing'>
