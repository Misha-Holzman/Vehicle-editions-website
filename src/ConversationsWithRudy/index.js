...
class ConversationsWithRudy extends Component {
  render () {
    return (
      <div className='convos-with-rudy-page-container'>
        <div className='convos-with-rudy-main-container'>
          <div className='available-titles-info-div-rudy'>
            <p className='available-titles-rudy-alt-name'>Conversations with Rudy Burckhardt About Everything</p>
          ...
          <p className='rudy-last-p rudy-text-body'>
...
export default ConversationsWithRudy
