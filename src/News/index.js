          ...
          <div className='news-main-container'>
            ...
            <div className='news-boxes-main-container'>
              <div className='news-container-boxes'>
                ...
                A reprint of Train Ride by Ted Berrigan, with cover by Joe Brainard (999 copies, offset) is at the printer and will be launched at the New York Art Book Fair at PS 1 in September
                </p>
              </div>
              <div className='news-container-boxes'>
              ...
              <div className='news-container-boxes'>
                <h3 className='news-container-box-title'><em>My First Three Books</em> by Tony Towle</h3>
                <p className='news-container-box-text'>
            ...
            <div className='news-boxes-main-container'>
              <div className='news-container-boxes'>
                ...
                <p className='news-container-box-text'>Documentary directed by Annabel Lee</p>
                <br />
